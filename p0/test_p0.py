...
class TestP0(unittest.TestCase):
    ...
    def test_exercise_6(self) -> None:
        ...
        self.check_expression(RE6, "01010101010011", True)
        self.check_expression(RE6, "010101010100110", True)
        self.check_expression(RE6, "01010101010010101010110101010", True)
        self.check_expression(RE6, "101010101010010101010110101010", True)
        self.check_expression(RE6, "010101010100101010101101010101", True)
        self.check_expression(RE6, "1010101010100101010101101010101", True)
        self.check_expression(RE6, "10101010101001010101011010101010", True)
        self.check_expression(RE6, "1100", True)
        self.check_expression(RE6, "101010101100", True)
        self.check_expression(RE6, "1010101011001", True)
        self.check_expression(RE6, "10101010110010101010", True)
        self.check_expression(RE6, "010101010110010101010", True)
        self.check_expression(RE6, "1010101011010101010010101010", True)
        self.check_expression(RE6, "10101010110101010100101010101", True)
        self.check_expression(RE6, "010101010110101010100101010101", True)

        self.check_expression(RE6, "0000", False)
        self.check_expression(RE6, "000101010101010100", False)
        self.check_expression(RE6, "001100", False)
        self.check_expression(RE6, "001101010101010100", False)
        self.check_expression(RE6, "00101010101101010101010100", False)
        self.check_expression(RE6, "0101010101111", False)
